...
sns.scatterplot(x = 'stop_rate', y = 'crime_rate', hue = 'policy_change', data = df, ax = ax3)
ax3.set_ylim(0,175)
ax3.set_xlim(0,350)
ax3.set_xlabel('Stops per 1,000 population')
ax3.set_ylabel('Reported offenses\nper 1,000 population')
ax3.set_title('Stop Rate and Crime Rate Vary\nover Time and across Precints')
leg = ax3.get_legend()
